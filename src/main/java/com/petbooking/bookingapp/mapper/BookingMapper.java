...
import com.petbooking.bookingapp.dto.BookingAdminReadOnlyDTO;
...
public class BookingMapper {
    ...
    public BookingAdminReadOnlyDTO toAdminDTO(Booking booking) {
        BookingAdminReadOnlyDTO dto = new BookingAdminReadOnlyDTO();
